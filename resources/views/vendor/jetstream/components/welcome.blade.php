    ...
    <div style="width: 900px;" class="container max-w-full mx-auto pt-4">
        ...
        <div class="grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
            <div class="p-5 bg-white rounded shadow-sm">
                ...
                <div class="flex items-center pt-1">
                    <div class="text-2xl font-bold text-gray-900 ">{{ \App\Models\ProductT::count() }}</div>
                </div>
            </div>
            <div class="p-5 bg-white rounded shadow-sm">
        ...
        <div class="grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
            <div class="p-5 bg-white rounded shadow-sm">
                ...
                <div class="flex items-center pt-1">
                    <div class="text-2xl font-bold text-gray-900 ">£{{ \App\Models\ProductT::sum('price') }}</div>
                </div>
            </div>
            <div class="p-5 bg-white rounded shadow-sm">
                <div class="text-base text-gray-400 ">Min Product Price</div>
                <div class="flex items-center pt-1">
                    <div class="text-2xl font-bold text-gray-900 ">£{{ \App\Models\ProductT::min('price') }}</div>
                </div>
            </div>
            <div class="p-5 bg-white rounded shadow-sm">
                <div class="text-base text-gray-400 ">Avg Product Price</div>
                <div class="flex items-center pt-1">
                    <div class="text-2xl font-bold text-gray-900 ">£{{ substr(\App\Models\ProductT::avg('price'),0, 5) }}</div>
                </div>
            </div>
            <div class="p-5 bg-white rounded shadow-sm">
                <div class="text-base text-gray-400 ">Max Product Price</div>
                <div class="flex items-center pt-1">
                    <div class="text-2xl font-bold text-gray-900 ">£{{ \App\Models\ProductT::max('price') }}</div>
                </div>
            </div>
        </div>
    </div>
